    ...
    try {
      if (editingStudent) {
        ...
        await api.put(`/students/${editingStudent._id}`, {
          ...
          enrolledCourses: formData.courseId
            ? [formData.courseId]
            : editingStudent.enrolledCourses.map((c) => c._id || c),
        });
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      {students.length > 0 ? (
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 text-center border border-gray-100 dark:border-gray-700">
          <div className="mx-auto w-16 h-16 bg-blue-50 dark:bg-blue-900/30 rounded-full flex items-center justify-center text-blue-500 mb-4">
            <UserPlus size={32} />
          </div>
