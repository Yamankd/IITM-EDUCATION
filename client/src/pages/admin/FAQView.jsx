...
const FAQView = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showError("Failed to create FAQ");
    } finally {
      setSaving(false);
    }
  };
    ...
    <div className="space-y-6">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-lg border border-gray-100 dark:border-gray-700 overflow-hidden transition-colors">
