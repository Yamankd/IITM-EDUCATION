...
const Courses = () => {
    ...
    const categories = ["all", "Computer Science", "Data Science", "Artificial Intelligence", "Web Development", "Mobile Development", "Cloud Computing"];
    const levels = ["all", "Beginner", "Intermediate", "Advanced"];
    const durations = ["all", "Under 10 weeks", "10-15 weeks", "16-20 weeks", "Over 20 weeks"];
        ...
        <div className="min-h-screen bg-gray-50 pt-24 pb-12">
            <div className="container mx-auto px-4 md:px-8">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold text-[#0B2A4A] mb-4">Our Courses</h1>
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Discover a wide range of courses designed to help you advance your skills and career.
                        Filter by category, level, or duration to find the perfect course for you.
                    </p>
                </div>
                                ...
                                {filteredCourses.map(course => (
                                    <div key={course.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                                        ...
                                        <div className="p-6">
                                            ...
                                            <h3 className="text-xl font-bold text-[#0B2A4A] mb-2">{course.title}</h3>
